...
export default function Footer() {
  return (
    <footer className="mb-8 mx-6 sm:mx-6 xl:mx-8 bg-[linear-gradient(90deg,#2a1338,#0e0e0e)] dark:bg-gray-900/80 border-t border-gray-200 dark:border-gray-800 transition-colors duration-300 rounded-xl">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-7 gap-8">
          <div className="xl:col-span-3 place-self-center xl:place-self-start w-full">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6 w-full xl:max-w-md text-center xl:text-left">
              ...
              in one click. 100% powered by Artificial Intelligence.
            </p>
          </div>
