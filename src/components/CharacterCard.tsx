  ...
  return (
    ...
    >
      <div className="relative max-h-[440px] bg-gradient-to-br from-purple-400/20 to-pink-400/20 dark:from-purple-400/10 dark:to-pink-400/10">
        ...
        {/* Video (overlayed, plays on hover) */}
        {videoUrl && (
          <video
            ref={videoRef}
            src={videoUrl}
        ...
        <div className="absolute bottom-0 left-0 right-0 text-white">
          <div className="flex justify-start flex-col px-3 py-4 lg:py-11 lg:px-8 gap:2 lg:gap-4">
            {isPremium && (
            ...
            <div className="flex gap-2 text-base lg:text-2xl ">
            ...
            <p className="text-sm line-clamp-2 leading-relaxed after:absolute after:inset-0 after:bg-[linear-gradient(rgba(0,_0,_0,_0)_50%,_rgba(0,_0,_0,_0.4))]">{description}</p>
          </div>
        </div>
      </div>
    </motion.div>
