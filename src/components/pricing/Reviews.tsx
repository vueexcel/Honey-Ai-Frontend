            ...
            {looped.map((r, idx) => (
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 relative rounded-full overflow-hidden flex justify-center items-center bg-[#1e1e1e]">
                    <svg
                      width="40"
                      height="43"
                      viewBox="0 0 40 43"
                ...
                {/* Review text */}
                <p className="text-gray-400 text-sm leading-relaxed min-h-[48px]">{r.text}</p>
              </article>
            ))}
          </div>
        </div>
