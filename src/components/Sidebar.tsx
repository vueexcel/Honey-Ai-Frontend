...
export default function Sidebar() {
  ...
  return (
    <motion.aside
      ...
      className="fixed left-0 top-0 h-[calc(100vh-64px)] bg-[linear-gradient(0deg,_#000c_-23.86%,_#281633cc_95.44%)] flex-col py-6 z-40 shadow-xl mt-16 overflow-hidden transition-all hidden xl:flex"
    >
      <div className="mt-4 mb-4 px-6 relative">
        {isSidebarOpen ? (
          ...
          <Button variant="gradient" className="w-11.5 h-11.5 rounded-xl flex items-center justify-center shadow-lg">
            <WandIcon size={22} />
          </Button>
        )}
      ...
      <div className="mt-8 mb-2 px-6">
        {isSidebarOpen ? (
          <div className="flex flex-col items-center justify-center gap-2 relative pt-3">
            <Link className="relative h-11 rounded-xl flex justify-center items-center" href="/contact">
          ...
          <Link className="relative h-11 rounded-xl flex justify-center items-center pt-3" href="/contact">
